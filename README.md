...
I'm **Mohamed (he/him)** - I'm a fullstack developer, designer, and hight school student. I'm interested in development, moderation, and building thriving online communities . I work on random projects in my free time.

![My skills](https://skillicons.dev/icons?i=rust,flutter,ts,express,nestjs,nextjs,angular,tailwind)
...
![My Tools & Platforms](https://skillicons.dev/icons?i=docker,prisma,git,github,linux,vscode,postgresql)
